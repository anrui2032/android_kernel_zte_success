...
return snprintf(buf, len, "Memory Type: %s\n"
		...
		"FirmWare Revision (ext_csd): 0x%x\n"
...
int mmc_attach_mmc(struct mmc_host *host)
{
	...
	/* [ECID:000000] ZTEBSP wangxiaomei record eMMC info into /proc/driver/emmc file, 20131108 */
#endif
